 ...
 */
final class Version20220725145336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fixed_sign ADD width INT NOT NULL, ADD height INT NOT NULL, ADD print_faces VARCHAR(30) NOT NULL, ADD material VARCHAR(30) NOT NULL, ADD finish VARCHAR(100) DEFAULT NULL, DROP image, DROP description');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fixed_sign ADD image VARCHAR(60) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP width, DROP height, DROP print_faces, DROP material, DROP finish, CHANGE title title VARCHAR(60) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE customer_reference customer_reference VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`');
