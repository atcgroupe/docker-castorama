 ...
 */
final class Version20210916073446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE aisle_order_sign (id INT AUTO_INCREMENT NOT NULL, item1_id INT NOT NULL, item2_id INT DEFAULT NULL, item3_id INT DEFAULT NULL, order_id INT NOT NULL, sign_id INT NOT NULL, aisle_number SMALLINT NOT NULL, hide_item2_image TINYINT(1) NOT NULL, hide_item3_image TINYINT(1) NOT NULL, quantity SMALLINT NOT NULL, INDEX IDX_272B01915AAD3E32 (item1_id), INDEX IDX_272B0191481891DC (item2_id), INDEX IDX_272B0191F0A4F6B9 (item3_id), INDEX IDX_272B01918D9F6D38 (order_id), INDEX IDX_272B01916FC7C15 (sign_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, member_id INT DEFAULT NULL, status_id VARCHAR(255) NOT NULL, title VARCHAR(100) NOT NULL, creation_time DATETIME NOT NULL, last_update_time DATETIME NOT NULL, delivery_date DATE DEFAULT NULL, customer_reference VARCHAR(20) DEFAULT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_F5299398A76ED395 (user_id), INDEX IDX_F52993987597D3FE (member_id), INDEX IDX_F52993986BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE order_status (id VARCHAR(255) NOT NULL, event_id VARCHAR(255) DEFAULT NULL, label VARCHAR(30) NOT NULL, UNIQUE INDEX UNIQ_B88F75C971F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sector_order_sign (id INT AUTO_INCREMENT NOT NULL, item1_id INT NOT NULL, item2_id INT DEFAULT NULL, order_id INT NOT NULL, sign_id INT NOT NULL, quantity SMALLINT NOT NULL, INDEX IDX_26E8DD625AAD3E32 (item1_id), INDEX IDX_26E8DD62481891DC (item2_id), INDEX IDX_26E8DD628D9F6D38 (order_id), INDEX IDX_26E8DD626FC7C15 (sign_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sign (id INT AUTO_INCREMENT NOT NULL, class VARCHAR(150) NOT NULL, image VARCHAR(60) NOT NULL, title VARCHAR(60) NOT NULL, description VARCHAR(255) NOT NULL, weight NUMERIC(4, 2) NOT NULL, switch_flow_builder VARCHAR(30) NOT NULL, switch_flow_template_file VARCHAR(30) NOT NULL, is_active TINYINT(1) NOT NULL, type VARCHAR(30) NOT NULL, price NUMERIC(5, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
