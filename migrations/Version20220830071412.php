 ...
 */
final class Version20220830071412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material_algeco_order_sign ADD dir VARCHAR(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material_algeco_order_sign DROP dir');
