 ...
 */
final class Version20220722080952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fixed_sign (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(60) NOT NULL, title VARCHAR(60) NOT NULL, description VARCHAR(255) NOT NULL, weight NUMERIC(4, 2) NOT NULL, is_active TINYINT(1) NOT NULL, price NUMERIC(5, 2) NOT NULL, customer_reference VARCHAR(30) NOT NULL, category SMALLINT NOT NULL, name VARCHAR(30) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material_algeco_sign_item CHANGE label label VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`');
