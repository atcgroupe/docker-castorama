 ...
 */
final class Version20210811063037 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE member_notification (id INT AUTO_INCREMENT NOT NULL, member_id INT NOT NULL, order_event VARCHAR(20) NOT NULL, INDEX IDX_CAE7E8427597D3FE (member_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE order_event_info (id VARCHAR(255) NOT NULL, label VARCHAR(60) NOT NULL, help VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE order_status (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(30) NOT NULL, order_event VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE member_notification ADD CONSTRAINT FK_CAE7E8427597D3FE FOREIGN KEY (member_id) REFERENCES member (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE member_notification DROP FOREIGN KEY FK_CAE7E8427597D3FE');
        ...
        $this->addSql('DROP TABLE member_notification');
        $this->addSql('DROP TABLE `order`');
        $this->addSql('DROP TABLE order_event_info');
