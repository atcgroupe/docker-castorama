 ...
 */
final class Version20220808070840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sign ADD name VARCHAR(100) NOT NULL, ADD width INT NOT NULL, ADD height INT NOT NULL, ADD finish VARCHAR(255) NOT NULL, ADD is_variable TINYINT(1) NOT NULL, DROP image, DROP type, CHANGE category print_faces SMALLINT NOT NULL, CHANGE description material VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sign ADD image VARCHAR(60) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD type VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP name, DROP width, DROP height, DROP material, DROP finish, DROP is_variable, CHANGE class class VARCHAR(150) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE title title VARCHAR(60) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE customer_reference customer_reference VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE switch_flow_builder switch_flow_builder VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE switch_flow_template_file switch_flow_template_file VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE print_faces category SMALLINT NOT NULL');
