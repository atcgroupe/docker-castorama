 ...
 */
final class Version20210903125737 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sign_item_category (id INT AUTO_INCREMENT NOT NULL, sign_id INT DEFAULT NULL, label VARCHAR(60) NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_29F995336FC7C15 (sign_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sign_item_category ADD CONSTRAINT FK_29F995336FC7C15 FOREIGN KEY (sign_id) REFERENCES sign (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sign_item_category DROP FOREIGN KEY FK_29F995336FC7C15');
