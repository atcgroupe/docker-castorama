 ...
 */
final class Version20220720082223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE material_dir_order_sign (id INT AUTO_INCREMENT NOT NULL, order_id INT NOT NULL, sign_id INT NOT NULL, title VARCHAR(2) NOT NULL, direction VARCHAR(10) NOT NULL, quantity SMALLINT NOT NULL, INDEX IDX_28FC05708D9F6D38 (order_id), INDEX IDX_28FC05706FC7C15 (sign_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE material_dir_order_sign ADD CONSTRAINT FK_28FC05708D9F6D38 FOREIGN KEY (order_id) REFERENCES `order` (id)');
        $this->addSql('ALTER TABLE material_dir_order_sign ADD CONSTRAINT FK_28FC05706FC7C15 FOREIGN KEY (sign_id) REFERENCES sign (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE material_dir_order_sign');
