 ...
 */
final class Version20220721082322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE material_algeco_order_sign (id INT AUTO_INCREMENT NOT NULL, item1_id INT NOT NULL, item2_id INT DEFAULT NULL, item3_id INT DEFAULT NULL, item4_id INT DEFAULT NULL, order_id INT NOT NULL, sign_id INT NOT NULL, quantity SMALLINT NOT NULL, INDEX IDX_B77155035AAD3E32 (item1_id), INDEX IDX_B7715503481891DC (item2_id), INDEX IDX_B7715503F0A4F6B9 (item3_id), INDEX IDX_B77155036D73CE00 (item4_id), INDEX IDX_B77155038D9F6D38 (order_id), INDEX IDX_B77155036FC7C15 (sign_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE material_algeco_sign_item (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(30) NOT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE material_algeco_order_sign ADD CONSTRAINT FK_B77155035AAD3E32 FOREIGN KEY (item1_id) REFERENCES material_algeco_sign_item (id)');
        $this->addSql('ALTER TABLE material_algeco_order_sign ADD CONSTRAINT FK_B7715503481891DC FOREIGN KEY (item2_id) REFERENCES material_algeco_sign_item (id)');
        $this->addSql('ALTER TABLE material_algeco_order_sign ADD CONSTRAINT FK_B7715503F0A4F6B9 FOREIGN KEY (item3_id) REFERENCES material_algeco_sign_item (id)');
        $this->addSql('ALTER TABLE material_algeco_order_sign ADD CONSTRAINT FK_B77155036D73CE00 FOREIGN KEY (item4_id) REFERENCES material_algeco_sign_item (id)');
        $this->addSql('ALTER TABLE material_algeco_order_sign ADD CONSTRAINT FK_B77155038D9F6D38 FOREIGN KEY (order_id) REFERENCES `order` (id)');
        $this->addSql('ALTER TABLE material_algeco_order_sign ADD CONSTRAINT FK_B77155036FC7C15 FOREIGN KEY (sign_id) REFERENCES sign (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE material_algeco_order_sign');
